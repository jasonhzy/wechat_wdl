...
(1, 'basic', '', '基本文字回复', '1.0', '和您进行简单对话', '一问一答得简单对话. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的回复内容.', 'wdl', 'http://bbs.b2ctui.com/', 0, '', '', 1, 1),
...
(3, 'music', '', '基本语音回复', '1.0', '提供语音、音乐等音频类回复', '在回复规则中可选择具有语音、音乐等音频类的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝，实现一问一答得简单对话。', 'Wdl', 'http://bbs.b2ctui.com/', 0, '', '', 1, 1),
(4, 'userapi', '', '自定义接口回复', '1.1', '更方便的第三方接口设置', '自定义接口又称第三方接口，可以让开发者更方便的接入微动力系统，高效的与微信公众平台进行对接整合。', 'Wdl', 'http://bbs.b2ctui.com/', 0, '', '', 1, 1),
(5, 'fans', 'customer', '粉丝管理', '1.1', '关注的粉丝管理', '', 'wdl', 'http://bbs.b2ctui.com', 0, 'a:8:{i:0;s:4:"text";i:1;s:5:"image";i:2;s:5:"voice";i:3;s:5:"video";i:4;s:8:"location";i:5;s:4:"link";i:6;s:9:"subscribe";i:7;s:11:"unsubscribe";}', 'a:0:{}', 0, 1),
(6, 'member', 'customer', '微会员', '1.2', '会员管理', '会员管理', 'wdl', '', 0, 'a:0:{}', '', 0, 1),
(7, 'nuqut','server','用户中心','1.4','提供我的公众号的服务','提供我的公众号的服务','微动力','http://bbs.b2ctui.com','0','a:7:{i:0;s:4:"text";i:1;s:5:"image";i:2;s:8:"location";i:3;s:4:"link";i:4;s:9:"subscribe";i:5;s:11:"unsubscribe";i:6;s:5:"click";}','a:1:{i:0;s:4:"text";}',0,1),
(8, 'oauth2','server','oAuth2.0特权','0.3','oAuth2.0特权','oAuth2.0特权','微动力','',0,'a:0:{}','a:1:{i:0;s:4:"text";}',0,1);

INSERT INTO `ims_site_templates` (`id`, `name`, `title`, `description`, `author`, `url`) VALUES
(1, 'default', '微站默认模板', '由微动力提供默认微站模板套系', '微动力团队', 'http://we7.cc');
