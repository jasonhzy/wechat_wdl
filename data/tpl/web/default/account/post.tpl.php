	...
	<div class="stat">
		<div class="stat-div">
				...
				<div class="navbar-inner">
					<div class="pull-left">
						<ul class="nav">
							...
							<li><a href="#accont-press" data-toggle="tab">一键绑定模式</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="sub-item" id="table-list">
					<div class="sub-content">
						<table class="tb">
							...
							<tr>
								<th><label for="">公众帐号引导关注</label></th>
								<td>
									<input type="text" name="accountlink" class="span6" value="<?php  echo $wechat['accountlink'];?>" autocomplete="off" />
									<span class="help-block">您的微信帐号或是易信帐号，引导关注页面，直接点击到引导关注页面</span>
								</td>
							</tr>
			...
			<div id="accont-press" class="tab-pane fade">
				<div class="sub-item">
					<h4 class="sub-title">一键绑定模式 <small>设置用户名密码后，程序会自动采集您的公众号相关信息。</small></h4>
				</div>
				<div class="sub-item" id="table-list">
					<div class="sub-content">
						<table class="tb">
                            ...
                            <tr>
								<th></td>
								<td>
								<font color="#FF0000">温馨提示：如发现获取失败，很有可能是验证码错误或账户密码错误（注意不要带空格）</font>
								</td>
							</tr>
