...
<h1 class="logo"><a href="/" title=""><img src="<?php  if(!empty($_W['setting']['copyright']['flogo'])) { ?><?php  echo $_W['attachurl'];?><?php  echo $_W['setting']['copyright']['flogo'];?><?php  } else { ?>./resource/image/logo.png<?php  } ?>" width="130" height="50" border="0" alt="" class="png"></a></h1>
...
<div class="infocus">
	<div class="focus_pic">
		<ul >
		<li><a href="/member.php?act=register&"><img src="./resource/weidongli/images/pic08.jpg" width="1920" height="612" alt="微信营销新时代"></a></li>
        ...
        <li><a ><img src="./resource/weidongli/images/pic11.jpg" width="1920" height="612" alt=""></a></li>
		<li><a ><img src="./resource/weidongli/images/pic12.jpg" width="1920" height="612" alt="微信营销新时代"></a></li>
        <li><a ><img src="./resource/weidongli/images/pic13.jpg" width="1920" height="612" alt=""></a></li>
...
<div class="footbg">
<div class="foot">
<p class="fl">Powered by <strong><a href="/" target="_blank">B2CTUI.COM</a></strong> <em>WDL2.0918</em>&nbsp--&copy; 2001-2014 <a href="/" target="_blank"><a href="/" target="_blank">微动力</a></a></p>
